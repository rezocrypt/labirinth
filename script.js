...
function calculate_points(coord) {
    let points = 0
...
function find_best_move() {
    ...
    for (let i = 0; i < valid_moves.length; i++) {
        moves_scores[i] = calculate_points(valid_moves[i])
    }
    return valid_moves[moves_scores.indexOf(Math.max.apply(0, moves_scores))];
